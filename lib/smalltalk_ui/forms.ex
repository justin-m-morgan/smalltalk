defmodule SmalltalkUi.Forms do
  use Phoenix.Component

  alias SmalltalkUi.Icon
  alias SmalltalkUi.Button
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SmalltalkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SmalltalkWeb.Gettext, "errors", msg, opts)
    end
  end
