defmodule Smalltalk.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind smalltalk", "esbuild smalltalk"],
      "assets.deploy": [
        "tailwind smalltalk --minify",
        "esbuild smalltalk --minify",
        "phx.digest"
      ]
    ]
  end
